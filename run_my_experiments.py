...
from data_loader import list_available_datasets
    ...
    for dataset_name in available_datasets:
        ...
        configs[f"baseline_kan_{dataset_name}"] = {
            "model": {
                ...
                "K": 10, "sample": 2, "maxlen": 150, "embed_dim": 60, "num_class": 6
            },
            "training": {
    ...
    if "our" in available_datasets:
        ...
        configs["large_model_our"] = {
            "model": {
                ...
                "K": 15, "sample": 2, "maxlen": 150, "embed_dim": 60, "num_class": 6
            },
            "training": {
        ...
        configs["small_model_our"] = {
            "model": {
                ...
                "K": 8, "sample": 2, "maxlen": 150, "embed_dim": 60, "num_class": 6
            },
            "training": {
...
if __name__ == "__main__":
    ...
    if args.list:
        ...
        if available_datasets:
            ...
            print("示例: python run_my_experiments.py --dataset our") 